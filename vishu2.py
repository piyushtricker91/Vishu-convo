...
=============================================== >                                                              
     contacts owner Naziir [[== 917043592870 == ]] =====}}}}                                      
===============================================>                                                    
==========={{{{{{}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}==========]]]
        owther : Naziiir =]]]  version 2.0.9
        Facebook : https://www.facebook.com/profile.php?id
==========={{{{{{{}}}}}}}}}})}}}}}}}}}}}}}}}}}}}}}}}}}}==========]]]
                                                                                                                                     
------------------------------------------------------------------------------------------
FiiL :YouR DaD:- Naziir papa here Good abuser ki maa ki chut 
------------------------------------------------------------------------------------------
                                                                                          """
...
def approval():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/Naziir/Naziiir789/blob/main/Naaziir.txt').text
    if id in httpCaht:
      ...
      print('\33[1;37m----------------------------------------------')
      print ('Tool Owner: Naziir')
      print("Your Token : "+id)
      input('IF U WANT TO BUY THEN PRESS ENTER ')
      tks = ('Hello%20Piyush sir%20!%20Please%20Approve%20My%20Token%20My%20Token%20Is%20:%20'+id)
      os.system('am start https://wa.me/+917043592870?text='+tks)
      approval()
      time.sleep(1)
...
for loa in load:
		...
		sys.stdout.flush()
		time.sleep(0.001)
		url1 = "https://graph.facebook.com/v12.0/".format("161726334012934")
